  ...
  return (
    <div className="all-tasks-container">
          ...
          <Row style={{ padding: "15px" }}>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <div>
                ...
                <button
                  className={`filter-button${
                    sortBy === "priority" ? "-selected" : ""
                  }`}
                  onClick={() => setSortBy("priority")}
                >
                  By priority <FontAwesomeIcon icon={faSort} />
                </button>
                <button
                  className={`filter-button${
                    sortBy === "status" ? "-selected" : ""
                  }`}
                  onClick={() => setSortBy("status")}
                >
                  By status <FontAwesomeIcon icon={faSort} />
                </button>
              </div>
              <div>
                <input
      ...
      {visibleTasks < filteredTasks.length && (
        <button onClick={loadMoreTasks} className="bottom-button">Load More</button>
      )}
    </div>
  );
};
